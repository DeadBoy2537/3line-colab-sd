...
function run {
    ...
    cd $BASEPATH && python launch.py --listen --share --no-half-vae --opt-split-attention --enable-insecure-extension-access --theme dark --clip-models-path $BASEPATH/models/CLIP
}
