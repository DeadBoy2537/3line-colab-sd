...
function run {
    ...
    cd $BASEPATH && python launch.py --listen --share --no-half-vae --xformers --opt-split-attention --medvram --enable-insecure-extension-access --theme dark --clip-models-path $BASEPATH/models/CLIP
}
